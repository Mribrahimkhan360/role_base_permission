    ...
    <div class="flex-grow">
        ...
        <nav class="bg-gray-100 border-b">
            <div class="container mx-auto px-4 py-3 flex items-center justify-between">
                <h5 class="text-lg font-medium">Create Role</h5>
            </div>
        </nav>
        ...
        <div class="container mx-auto my-10 px-4">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <div class="bg-blue-600 text-white px-6 py-4">
                    <h4 class="text-xl font-semibold">Add New Role</h4>
                </div>
                ...
                <!-- Form -->
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" placeholder="Enter role name"
                                       class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"/>
                            </div>
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
                                    @foreach($permissions as $permission)
                                        <div class="flex items-center">
                                            ...
                                            <label for="perm_{{ $permission->id }}" class="ml-2 text-gray-700">
                                                {{ $permission->name }}
                                            </label>
                                        </div>
                                    @endforeach
                        ...
                        <div class="flex justify-end mt-6 space-x-3">
                            <button type="reset" class="bg-gray-500 hover:bg-gray-600 text-white font-medium px-4 py-2 rounded">
                                Reset
                            </button>
